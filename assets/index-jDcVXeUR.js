	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
            ...
            I also play a part in developing the Stream Loading System that is used to help with optimization throughout the game world.</p> <div class="wr-combat svelte-107f7ce"><div class="combat-txt svelte-107f7ce"><p>The purpose for the weather system is to implement weather that makes the world feel like it is constantly changing.
                    ...
                    Depending on the weather conditions and time of day, your sea traversal may vary. Some places will only be traversable depending on when the tides are lower or higher.</p></div> <div class="video-wrapper svelte-107f7ce"><iframe class="media-iframe water-gif svelte-107f7ce" data-src="https://www.youtube-nocookie.com/embed/OwQqwBWH-lM?si=yg7W-i4MHf1FfRsc" title="Wayward Realms Water System Demo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" loading="lazy"></iframe></div></div></section> <section class="job-section Ard_Main svelte-107f7ce"><h3>Ardenfall</h3> <h5 class="skill-tool svelte-107f7ce">Skills/Tools: Unity, C#</h5> <p>As a Gameplay Programmer for Ardenfall, I work on various bug fixes to help keep the game running in a smooth, bug free state.
            I also work on implementing small features that help make the game feel more robust and full of content.</p> <div class="ard-container svelte-107f7ce"><div class="ard-txt svelte-107f7ce"><p>I deep dive into the game's code, utilizing my knowledge of C# to find and fix bugs that negatively impact the game's performance.
                    On top of problem solving and implementing effective fixes, I contribute details to make various systems, such as the leveling/skill point system and stamina system, more rounded and more immersive.</p></div> <div class="video-wrapper svelte-107f7ce"><iframe class="media-iframe ard-gif svelte-107f7ce" data-src="https://www.youtube-nocookie.com/embed/ac8To4rplk0?si=GERL7MCZkIGWF9vl" title="Ardenfall Gameplay Demo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" loading="lazy"></iframe></div></div></section> <section class="job-section OA_Main svelte-107f7ce"><h3>Ocean Aero</h3> <h5 class="skill-tool svelte-107f7ce">Skills/Tools: JavaScript, Laravel, PHP, MySQL, C, Python, UE5</h5> <p>As a Software Engineer, I worked on the Full Stack Development of the GUI for controlling the Triton, which is an autonomous sail/submergible boat.
            I also helped with creating simulations using UE5 to take Semantic Segmentation images for Deep Learning to train the AI to understand different obstacles for Obstacle Avoidance.</p> <div class="oa-container svelte-107f7ce"><div class="oa-txt svelte-107f7ce"><p>Being on a small team of Software Engineers, we had multiple hats we would have to wear in order to get the job done.
            ...
            which is their autonomous boat.</p></div></main>`);function _g(n){var e=mg();yn(n,e)}function gg(){const n={form:document.querySelector("form"),name:document.getElementById("name"),email:document.getElementById("email"),message:document.getElementById("message"),submit:document.querySelector(".submit-btn"),reset:document.querySelector(".reset-btn")};if(!n.form||!n.name||!n.email||!n.message||!n.submit)return console.warn("Contact form error: Required DOM elements not found"),()=>{};const e={colors:{active:{background:"rgb(224, 240, 227, 0.9)",color:"rgba(141, 136, 136)"},inactive:{background:"rgba(141, 136, 136, 0.8)",color:"#ffff"}}};function t(l){const c=l?e.colors.active:e.colors.inactive;n.submit.style.backgroundColor=c.background,n.submit.style.color=c.color,n.submit.disabled=!l}function i(){const l=n.name.value.trim()&&n.email.value.trim()&&n.message.value.trim();t(l)}function r(l){n.submit.disabled=!0,n.submit.value="Sending...",setTimeout(()=>{s()},3e3)}function s(){n.submit.disabled=!1,n.submit.value="Send Message",n.message.value="",t(!1)}function a(){setTimeout(()=>{s()},0)}const o=()=>i();return n.name.addEventListener("input",o),n.email.addEventListener("input",o),n.message.addEventListener("input",o),n.form.addEventListener("submit",r),n.form.addEventListener("reset",a),s(),function(){var c,u,f,h,m;(c=n.name)==null||c.removeEventListener("input",o),(u=n.email)==null||u.removeEventListener("input",o),(f=n.message)==null||f.removeEventListener("input",o),(h=n.form)==null||h.removeEventListener("submit",r),(m=n.form)==null||m.removeEventListener("reset",a)}}var vg=An('<main class="svelte-1mgfcuj"><section class="svelte-1mgfcuj"><h2 class="svelte-1mgfcuj">Contact</h2> <form method="POST" action="https://formsubmit.co/bfc62655bac83c0b0969fe864e79f09d" name="contactForm" class="svelte-1mgfcuj"><input type="hidden" name="_next" value="https://calebaddi.github.io/addicoding" class="svelte-1mgfcuj"/> <input type="hidden" name="_captcha" value="true" class="svelte-1mgfcuj"/> <input type="hidden" name="_template" value="table" class="svelte-1mgfcuj"/> <div class="fields svelte-1mgfcuj"><div class="field half svelte-1mgfcuj"><label for="name" class="svelte-1mgfcuj">Name</label> <input type="text" name="name" id="name" required autocomplete="name" placeholder="* Your name" maxlength="100" class="svelte-1mgfcuj"/></div> <div class="field half svelte-1mgfcuj"><label for="email" class="svelte-1mgfcuj">Email</label> <input type="email" name="email" id="email" required autocomplete="email" placeholder="* your.email@example.com" maxlength="254" class="svelte-1mgfcuj"/></div> <div class="field svelte-1mgfcuj"><label for="message" class="svelte-1mgfcuj">Message</label> <textarea name="message" id="message" rows="6" required placeholder="* Your message here..." maxlength="2000" class="svelte-1mgfcuj"></textarea></div></div> <ul class="actions svelte-1mgfcuj"><li class="svelte-1mgfcuj"><input type="submit" value="Send Message" class="primary submit-btn svelte-1mgfcuj" style="margin-bottom: 1.7em;" disabled/></li> <li class="svelte-1mgfcuj"><input type="reset" value="Reset" class="reset-btn svelte-1mgfcuj"/></li></ul></form> <ul class="icons svelte-1mgfcuj"><li class="linkIcons svelte-1mgfcuj"><a href="https://www.linkedin.com/in/caleb-addi/" target="_blank" rel="noopener noreferrer" class="icon brands svelte-1mgfcuj" style="margin-left: -5em;" id="linkedin-icon" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in svelte-1mgfcuj"></i></a></li> <li class="linkIcons svelte-1mgfcuj"><a href="https://github.com/CalebAddi" target="_blank" rel="noopener noreferrer" class="icon brands svelte-1mgfcuj" style="margin-right: -5em; margin-top: -1.1em;" id="github-icon" aria-label="GitHub"><i class="fa-brands fa-github svelte-1mgfcuj"></i></a></li></ul></section></main>');function xg(n,e){Ii(e,!1);let t=null;Bi(()=>{setTimeout(()=>{try{t=gg()}catch(s){console.error("Contact Form initializing error: ",s)}},0)}),Wa(()=>{try{t&&typeof t=="function"&&t()}catch(r){console.error("Contact Form cleanup error: ",r)}}),nr();var i=vg();yn(n,i),Ni()}function Sg(){const n={articles:document.querySelectorAll("article"),navLinks:document.querySelectorAll(".nav-li a"),appContainer:document.querySelectorAll(".app-container"),resumeArticle:document.getElementById("resume"),navButtons:document.querySelector(".nav-buttons")};let e=null;if(!n.articles.length||!n.navLinks.length){console.warn("Navigation: Required DOM elements are missing");return}function t(){n.articles.forEach(u=>{u.id!=="resume"&&(u.style.display="none")}),i(!1)}function i(u){!n.appContainer||!n.resumeArticle||(n.appContainer[0].classList.toggle("article-active",u),n.resumeArticle.style.display=u?"none":"block")}function r(u){n.articles.forEach(f=>{f.id!=="resume"&&(f.style.display="none")}),u&&u.id!=="resume"&&(u.style.display="block",e=u,i(!0))}function s(){n.articles.forEach(u=>{u.id!=="resume"&&(u.style.display="none")}),e=null,i(!1)}function a(u){u.preventDefault();const f=u.currentTarget.getAttribute("href").slice(1);if(!f)return;const h=document.getElementById(f);if(h===e){s();return}h&&r(h)}function o(){n.navLinks.forEach(u=>{u.addEventListener("click",a,{passive:!1})})}function l(){n.navLinks.forEach(u=>{u.removeEventListener("click",a)})}function c(){l(),e=null}try{return t(),o(),c}catch(u){return console.error("Navigation initialization failed: ",u),null}}var Mg=An('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"/>'),Eg=An('<main class="app-container"><div class="navbar svelte-19meq5b"><!></div> <div class="main"><article id="resume" class="svelte-19meq5b"><!></article> <article id="professional_work" class="svelte-19meq5b"><!></article> <article id="personal_work" class="svelte-19meq5b"><!></article> <article id="about" class="svelte-19meq5b"><!></article> <article id="contact" class="svelte-19meq5b"><!></article></div> <div class="canvas svelte-19meq5b"><!></div></main>');function yg(n,e){Ii(e,!1);let t=null;Bi(()=>{requestAnimationFrame(()=>{try{t=Sg()}catch(M){console.error("Error initializing site navigation: ",M)}})}),Wa(()=>{try{t&&typeof t=="function"&&t()}catch(y){console.error("Error during onDestroy call: ",y)}}),nr();var i=Eg();Cu(y=>{var M=Mg();yn(y,M)});var r=tn(i),s=tn(r);lg(s);var a=si(r,2),o=tn(a),l=tn(o);ug(l);var c=si(o,2),u=tn(c);hg(u,{});var f=si(c,2),h=tn(f);pg(h,{});var m=si(f,2),g=tn(m);_g(g);var S=si(m,2),p=tn(S);xg(p,{});var d=si(a,2),T=tn(d);ag(T,{}),yn(n,i),Ni()}Lu(yg,{target:document.getElementById("app")});
