...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function xa(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ls(),fragmentShader:`
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function Ma(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ls(),fragmentShader:`
	...
	`}function Sd(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Xr||c===qr,h=c===jn||c===$n;if(l||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let f=e.get(a);return t===null&&(t=new ga(i)),f=l?t.fromEquirectangular(a,f):t.fromCubemap(a,f),e.set(a,f),f.texture}else{if(e.has(a))return e.get(a).texture;{const f=a.image;if(l&&f&&f.height>0||h&&f&&r(f)){t===null&&(t=new ga(i));const d=l?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,d),a.addEventListener("dispose",s),d.texture}else return null}}}return a}function r(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Ed(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function yd(i,e,t,n){const r={},s=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const x in d.attributes)e.remove(d.attributes[x]);for(const x in d.morphAttributes){const v=d.morphAttributes[x];for(let p=0,u=v.length;p<u;p++)e.remove(v[p])}d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(f,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function c(f){const d=f.attributes;for(const x in d)e.update(d[x],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const x in m){const v=m[x];for(let p=0,u=v.length;p<u;p++)e.update(v[p],i.ARRAY_BUFFER)}}function l(f){const d=[],m=f.index,x=f.attributes.position;let v=0;if(m!==null){const y=m.array;v=m.version;for(let M=0,E=y.length;M<E;M+=3){const A=y[M+0],C=y[M+1],w=y[M+2];d.push(A,C,C,w,w,A)}}else if(x!==void 0){const y=x.array;v=x.version;for(let M=0,E=y.length/3-1;M<E;M+=3){const A=M+0,C=M+1,w=M+2;d.push(A,C,C,w,w,A)}}else return;const p=new(ro(d)?fo:ho)(d,1);p.version=v;const u=s.get(f);u&&e.remove(u),s.set(f,p)}function h(f){const d=s.get(f);if(d){const m=f.index;m!==null&&d.version<m.version&&l(f)}else l(f);return s.get(f)}return{get:a,update:c,getWireframeAttribute:h}}function Td(i,e,t,n){const r=n.isWebGL2;let s;function o(d){s=d}let a,c;function l(d){a=d.type,c=d.bytesPerElement}function h(d,m){i.drawElements(s,m,a,d*c),t.update(m,s,1)}function f(d,m,x){if(x===0)return;let v,p;if(r)v=i,p="drawElementsInstanced";else if(v=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",v===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}v[p](s,m,a,d*c,x),t.update(m,s,x)}this.setMode=o,this.setIndex=l,this.render=h,this.renderInstances=f}function bd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Ad(i,e){return i[0]-e[0]}function wd(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Rd(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new nt,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function c(l,h,f){const d=l.morphTargetInfluences;if(e.isWebGL2===!0){const x=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,v=x!==void 0?x.length:0;let p=s.get(h);if(p===void 0||p.count!==v){let W=function(){F.dispose(),s.delete(h),h.removeEventListener("dispose",W)};var m=W;p!==void 0&&p.texture.dispose();const M=h.morphAttributes.position!==void 0,E=h.morphAttributes.normal!==void 0,A=h.morphAttributes.color!==void 0,C=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],z=h.morphAttributes.color||[];let g=0;M===!0&&(g=1),E===!0&&(g=2),A===!0&&(g=3);let b=h.attributes.position.count*g,j=1;b>e.maxTextureSize&&(j=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const $=new Float32Array(b*j*4*v),F=new oo($,b,j,v);F.type=en,F.needsUpdate=!0;const k=g*4;for(let K=0;K<v;K++){const X=C[K],q=w[K],J=z[K],Y=b*j*4*K;for(let N=0;N<X.count;N++){const V=N*k;M===!0&&(o.fromBufferAttribute(X,N),$[Y+V+0]=o.x,$[Y+V+1]=o.y,$[Y+V+2]=o.z,$[Y+V+3]=0),E===!0&&(o.fromBufferAttribute(q,N),$[Y+V+4]=o.x,$[Y+V+5]=o.y,$[Y+V+6]=o.z,$[Y+V+7]=0),A===!0&&(o.fromBufferAttribute(J,N),$[Y+V+8]=o.x,$[Y+V+9]=o.y,$[Y+V+10]=o.z,$[Y+V+11]=J.itemSize===4?o.w:1)}}p={count:v,texture:F,size:new Oe(b,j)},s.set(h,p),h.addEventListener("dispose",W)}let u=0;for(let M=0;M<d.length;M++)u+=d[M];const y=h.morphTargetsRelative?1:1-u;f.getUniforms().setValue(i,"morphTargetBaseInfluence",y),f.getUniforms().setValue(i,"morphTargetInfluences",d),f.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),f.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const x=d===void 0?0:d.length;let v=n[h.id];if(v===void 0||v.length!==x){v=[];for(let E=0;E<x;E++)v[E]=[E,0];n[h.id]=v}for(let E=0;E<x;E++){const A=v[E];A[0]=E,A[1]=d[E]}v.sort(wd);for(let E=0;E<8;E++)E<x&&v[E][1]?(a[E][0]=v[E][0],a[E][1]=v[E][1]):(a[E][0]=Number.MAX_SAFE_INTEGER,a[E][1]=0);a.sort(Ad);const p=h.morphAttributes.position,u=h.morphAttributes.normal;let y=0;for(let E=0;E<8;E++){const A=a[E],C=A[0],w=A[1];C!==Number.MAX_SAFE_INTEGER&&w?(p&&h.getAttribute("morphTarget"+E)!==p[C]&&h.setAttribute("morphTarget"+E,p[C]),u&&h.getAttribute("morphNormal"+E)!==u[C]&&h.setAttribute("morphNormal"+E,u[C]),r[E]=w,y+=w):(p&&h.hasAttribute("morphTarget"+E)===!0&&h.deleteAttribute("morphTarget"+E),u&&h.hasAttribute("morphNormal"+E)===!0&&h.deleteAttribute("morphNormal"+E),r[E]=0)}const M=h.morphTargetsRelative?1:1-y;f.getUniforms().setValue(i,"morphTargetBaseInfluence",M),f.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:c}}function Cd(i,e,t,n){let r=new WeakMap;function s(c){const l=n.render.frame,h=c.geometry,f=e.get(c,h);if(r.get(f)!==l&&(e.update(f),r.set(f,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;r.get(d)!==l&&(d.update(),r.set(d,l))}return f}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}const xo=new xt,Mo=new oo,So=new mc,Eo=new _o,Sa=[],Ea=[],ya=new Float32Array(16),Ta=new Float32Array(9),ba=new Float32Array(4);function Qn(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Sa[r];if(s===void 0&&(s=new Float32Array(r),Sa[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function Ze(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Je(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ji(i,e){let t=Ea[e];t===void 0&&(t=new Int32Array(e),Ea[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Ld(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Pd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ze(t,e))return;i.uniform2fv(this.addr,e),Je(t,e)}}function Ud(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Ze(t,e))return;i.uniform3fv(this.addr,e),Je(t,e)}}function Dd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ze(t,e))return;i.uniform4fv(this.addr,e),Je(t,e)}}function Id(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ze(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Je(t,e)}else{if(Ze(t,n))return;ba.set(n),i.uniformMatrix2fv(this.addr,!1,ba),Je(t,n)}}function Nd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ze(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Je(t,e)}else{if(Ze(t,n))return;Ta.set(n),i.uniformMatrix3fv(this.addr,!1,Ta),Je(t,n)}}function Fd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ze(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Je(t,e)}else{if(Ze(t,n))return;ya.set(n),i.uniformMatrix4fv(this.addr,!1,ya),Je(t,n)}}function Od(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Bd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ze(t,e))return;i.uniform2iv(this.addr,e),Je(t,e)}}function zd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ze(t,e))return;i.uniform3iv(this.addr,e),Je(t,e)}}function Gd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ze(t,e))return;i.uniform4iv(this.addr,e),Je(t,e)}}function Hd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Vd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ze(t,e))return;i.uniform2uiv(this.addr,e),Je(t,e)}}function kd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ze(t,e))return;i.uniform3uiv(this.addr,e),Je(t,e)}}function Wd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ze(t,e))return;i.uniform4uiv(this.addr,e),Je(t,e)}}function Xd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||xo,r)}function qd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||So,r)}function Yd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Eo,r)}function jd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Mo,r)}function $d(i){switch(i){case 5126:return Ld;case 35664:return Pd;case 35665:return Ud;case 35666:return Dd;case 35674:return Id;case 35675:return Nd;case 35676:return Fd;case 5124:case 35670:return Od;case 35667:case 35671:return Bd;case 35668:case 35672:return zd;case 35669:case 35673:return Gd;case 5125:return Hd;case 36294:return Vd;case 36295:return kd;case 36296:return Wd;case 35678:case 36198:case 36298:case 36306:case 35682:return Xd;case 35679:case 36299:case 36307:return qd;case 35680:case 36300:case 36308:case 36293:return Yd;case 36289:case 36303:case 36311:case 36292:return jd}}function Kd(i,e){i.uniform1fv(this.addr,e)}function Zd(i,e){const t=Qn(e,this.size,2);i.uniform2fv(this.addr,t)}function Jd(i,e){const t=Qn(e,this.size,3);i.uniform3fv(this.addr,t)}function Qd(i,e){const t=Qn(e,this.size,4);i.uniform4fv(this.addr,t)}function ef(i,e){const t=Qn(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function tf(i,e){const t=Qn(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function nf(i,e){const t=Qn(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function rf(i,e){i.uniform1iv(this.addr,e)}function sf(i,e){i.uniform2iv(this.addr,e)}function af(i,e){i.uniform3iv(this.addr,e)}function of(i,e){i.uniform4iv(this.addr,e)}function lf(i,e){i.uniform1uiv(this.addr,e)}function cf(i,e){i.uniform2uiv(this.addr,e)}function uf(i,e){i.uniform3uiv(this.addr,e)}function hf(i,e){i.uniform4uiv(this.addr,e)}function df(i,e,t){const n=this.cache,r=e.length,s=Ji(t,r);Ze(n,s)||(i.uniform1iv(this.addr,s),Je(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||xo,s[o])}function ff(i,e,t){const n=this.cache,r=e.length,s=Ji(t,r);Ze(n,s)||(i.uniform1iv(this.addr,s),Je(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||So,s[o])}function pf(i,e,t){const n=this.cache,r=e.length,s=Ji(t,r);Ze(n,s)||(i.uniform1iv(this.addr,s),Je(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Eo,s[o])}function mf(i,e,t){const n=this.cache,r=e.length,s=Ji(t,r);Ze(n,s)||(i.uniform1iv(this.addr,s),Je(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Mo,s[o])}function _f(i){switch(i){case 5126:return Kd;case 35664:return Zd;case 35665:return Jd;case 35666:return Qd;case 35674:return ef;case 35675:return tf;case 35676:return nf;case 5124:case 35670:return rf;case 35667:case 35671:return sf;case 35668:case 35672:return af;case 35669:case 35673:return of;case 5125:return lf;case 36294:return cf;case 36295:return uf;case 36296:return hf;case 35678:case 36198:case 36298:case 36306:case 35682:return df;case 35679:case 36299:case 36307:return ff;case 35680:case 36300:case 36308:case 36293:return pf;case 36289:case 36303:case 36311:case 36292:return mf}}class gf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=$d(t.type)}}class vf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=_f(t.type)}}class xf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Ir=/(\w+)(\])?(\[|\.)?/g;function Aa(i,e){i.seq.push(e),i.map[e.id]=e}function Mf(i,e,t){const n=i.name,r=n.length;for(Ir.lastIndex=0;;){const s=Ir.exec(n),o=Ir.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Aa(t,l===void 0?new gf(a,i,e):new vf(a,i,e));break}else{let f=t.map[a];f===void 0&&(f=new xf(a),Aa(t,f)),t=f}}}class Xi{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Mf(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function wa(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let Sf=0;function Ef(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function yf(i){switch(i){case Nt:return["Linear","( value )"];case Re:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function Ra(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Ef(i.getShaderSource(e),o)}else return r}function Tf(i,e){const t=yf(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function bf(i,e){let t;switch(e){case Pl:t="Linear";break;case Ul:t="Reinhard";break;case Dl:t="OptimizedCineon";break;case Il:t="ACESFilmic";break;case Nl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Af(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ai).join(`
`)}function wf(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Rf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ai(i){return i!==""}function Ca(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function La(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Cf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Jr(i){return i.replace(Cf,Pf)}const Lf=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Pf(i,e){let t=we[e];if(t===void 0){const n=Lf.get(e);if(n!==void 0)t=we[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Jr(t)}const Uf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Pa(i){return i.replace(Uf,Df)}function Df(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ua(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function If(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Xa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===cl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Wt&&(e="SHADOWMAP_TYPE_VSM"),e}function Nf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case jn:case $n:e="ENVMAP_TYPE_CUBE";break;case $i:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ff(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case $n:e="ENVMAP_MODE_REFRACTION";break}return e}function Of(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ja:e="ENVMAP_BLENDING_MULTIPLY";break;case Cl:e="ENVMAP_BLENDING_MIX";break;case Ll:e="ENVMAP_BLENDING_ADD";break}return e}function Bf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function zf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=If(t),l=Nf(t),h=Ff(t),f=Of(t),d=Bf(t),m=t.isWebGL2?"":Af(t),x=wf(s),v=r.createProgram();let p,u,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
              ...
              I also play a part in developing the Stream Loading System that is used to help with optimization throughout the game world.</p> <div class="wr-combat"><div class="combat-txt"><p>The purpose for the weather system is to implement weather that makes the world feel like it is constantly changing.
                  ...
                  Depending on the weather conditions and time of day, your sea traversal may vary. Some places will only be traversable depending on when the tides are lower or higher.</p></div> <iframe class="water-gif" src="https://www.youtube.com/embed/OwQqwBWH-lM?si=lc6vPXqEckI8dsql" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe> <div class="water-gif02"></div></div></div> <div class="Ard_Main"><h3>Ardenfall</h3> <h5 class="skill-tool">Skills/Tools: Unity, C#</h5> <p>As a Gameplay Programmer for Ardenfall, I work on various bug fixes to help keep the game running in a smooth, bug free state.
              ...
              I also helped with creating simulations using UE5 to take Semantic Segmentation images for Deep Learning to train the AI to understand different obstacles for Obstacle Avoidance.</p> <div class="oa-container"><div class="oa-txt"><p>Being on a small team of Software Engineers, we had multiple hats we would have to wear in order to get the job done.
                  ...
                  Using UE5, we were able to fast track the machine learning process of the Triton, saving hundreds of man hours and thousands of dollars to get the outcome we needed.</p></div> <div class="oa-vid"><iframe class="oa-img" src="https://www.youtube.com/embed/fybcM4BzEtA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div></div></div></article> <article id="personal_work"><h2>Personal Projects</h2> <div class="personalGames-main"><h3 style="border-bottom: solid 1px rgb(215, 200, 200, 0.7); padding-bottom: 0.5em; text-shadow: 5px 5px black;">Prototype Game Projects</h3> <div class="span_div"><span><div class="project-desc"><p style="padding-left: 0.5em; padding-right: 0.5em; color:rgb(215, 200, 200, 1); text-shadow: 1px 1px black;">The White Pages is a horror game that I am working on in my spare time. 
                    ...
                    Randomization Mechanics (Items and Enemy Spawn Locations), Portal System, and Basic Test UI.</p> <h4 style="padding-top: 2em; padding-bottom: -2em;">Project Link:  
                    <a href="https://github.com/CalebAddi/TheWhitePages" target="_blank" class="icon brands" id="github-icon"><i class="fa-brands fa-github"></i></a></h4></div> <iframe class="devclip-vid" src="https://www.youtube.com/embed/1Ynm_oknozI?si=cLNH-_F63IS_jGgD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe> <h3 class="h3_lilJS">The White Pages</h3> <p style="padding-left: 0.5em; padding-right: 0.5em; color:rgb(215, 200, 200, 1); text-shadow: 1px 1px black;">Unreal Engine | C++ | Blueprints</p></span></div></div> <div class="web_main"><h3 style="border-bottom: solid 1px rgb(215, 200, 200, 0.7); padding-bottom: 0.5em; text-shadow: 5px 5px black;">Simple Web Projects</h3> <div class="span_div"><span><a href="https://celadon-daifuku-b4fd9b.netlify.app/" target="_blank"><img class="span_img" src="assets/images/shopify.png" alt="Simple-React-Template"/></a> <h3>Admin Dashboard</h3></span> <p style="padding-left: 0.5em; padding-right: 0.5em; color:rgb(215, 200, 200, 1); text-shadow: 1px 1px black;">React JS</p></div> <div class="span_div"><span><a href="https://spiffy-liger-2e0760.netlify.app/" target="_blank"><img class="span_img" src="assets/images/planetearth.png" alt="threejs-globe"/></a> <h3>Earth Charity Hub</h3></span> <p style="padding-left: 0.5em; padding-right: 0.5em; color:rgb(215, 200, 200, 1); text-shadow: 1px 1px black;">THREE JS</p></div></div> <div class="jsGame-main"><h3 style="border-bottom: solid 1px rgb(215, 200, 200, 0.7); padding-bottom: 0.5em; text-shadow: 5px 5px black;">Simple JS Games</h3> <div class="span_div"><span><a href="assets/projects/FirstJSGame/index.html" target="_blank"><img class="span_img" src="assets/images/surviveswarm.png" alt=""/></a> <h3 class="h3_lilJS">Survive The Swarm</h3></span></div> <div class="span_div"><span><a href="assets/projects/DiceGame/index.html" target="_blank"><img class="span_img" src="assets/images/diceroll.png" alt=""/></a> <h3 class="h3_lilJS">Dice Roll (Requires 2 Players)</h3></span></div> <div class="span_div"><span><a href="assets/projects/GuessMyNumber/index.html" target="_blank"><img class="span_img" src="assets/images/guessnum.png" alt=""/></a> <h3 class="h3_lilJS">Guess The Number</h3></span></div></div></article> <article id="about"><h2>About</h2> <div class="about-container"><span><img class="span_img" src="assets/images/addiimg01.JPG" alt="" style="margin-bottom: 1em;"/></span> <p>My name is Caleb, and I&#39;m a Software Engineer.</p> <p>As a Software Engineer, I work on various gameplay systems by developing them using both C++ and Blueprint Scripting for a game called The Wayward Realms. 
              ...
              which is their autonomous boat.</p></div></article> <article id="contact"><h2>Contact</h2> <form method="POST" action="https://formsubmit.co/caleb.addi.77@gmail.com"><input type="hidden" name="_next" value="https://calebaddi.github.io/addicoding"/> <div class="fields"><div class="field half"><label for="name">Name</label> <input type="text" name="name" id="name" required=""/></div> <div class="field half"><label for="email">Email</label> <input type="text" name="email" id="email" required=""/></div> <div class="field"><label for="message">Message</label> <textarea name="message" id="message" rows="4"></textarea></div></div> <ul class="actions"><li><input type="submit" value="Send Message" class="primary submit-btn" style="margin-bottom: 1.7em;"/></li> <li><input type="reset" value="Reset" class="reset-btn"/></li></ul></form> <ul class="icons"><li class="linkIcons"><a href="https://www.linkedin.com/in/caleb-addi/" target="_blank" class="icon brands" style="margin-left: -5em;" id="linkedin-icon"><i class="fa-brands fa-linkedin-in"></i></a></li> <li class="linkIcons"><a href="https://github.com/CalebAddi" target="_blank" class="icon brands" style="margin-right: -5em; margin-top: -1.1em;" id="github-icon"><i class="fa-brands fa-github"></i></a></li></ul></article></div></body>`,Xo(n,"class","home_container")},m(r,s){rr(r,e,s),i[1](e),rr(r,t,s),rr(r,n,s)},p:Wn,i:Wn,o:Wn,d(r){r&&(Wi(e),Wi(t),Wi(n)),i[1](null)}}}function wp(i,e,t){let n;jo(()=>{bp(n)});function r(s){Gr[s?"unshift":"push"](()=>{n=s,t(0,n)})}return[n,r]}class Rp extends sl{constructor(e){super(),rl(this,e,wp,Ap,Ho,{})}}new Rp({target:document.getElementById("app")});window.onload=function(){const i=document.querySelectorAll("article");let e=null;i.forEach(r=>{r.style.display="none"});const t=document.querySelectorAll(".nav-li a");function n(r){const s=document.querySelector(".home_container"),o=document.getElementById("resume");s&&(s.style.marginBottom=r?"0":"-10em",o.style.display=r?"none":"block")}n(!1),t.forEach(r=>{r.addEventListener("click",function(s){s.preventDefault(),i.forEach(l=>{l.style.display="none"}),n(!1);const o=this.getAttribute("href").slice(1),a=document.getElementById(o),c=document.querySelector(".nav-buttons");a&&(a===e?(a.style.display="none",e=null,n(!1),o==="about"&&c&&(c.style.marginLeft="")):(e&&(e.style.display="none"),a.style.display="block",e=a,n(!0)))})})};const Po=document.getElementById("name"),Uo=document.getElementById("email"),Do=document.getElementById("message"),tn=document.querySelector(".submit-btn");document.querySelector(".reset-btn");function hs(){let i=Po.value.trim(),e=Uo.value.trim(),t=Do.value.trim();i&&e&&t?(tn.style.backgroundColor="rgb(224, 240, 227, 0.9)",tn.style.color="rgba(141, 136, 136)"):(tn.style.backgroundColor="rgba(141, 136, 136, 0.8)",tn.style.color="#ffff")}Po.addEventListener("input",hs);Uo.addEventListener("input",hs);Do.addEventListener("input",hs);document.querySelector("form").addEventListener("submit",function(){tn.style.backgroundColor="rgba(141, 136, 136, 0.8)",tn.style.color="#ffff"});document.querySelector("form").addEventListener("reset",function(){tn.style.backgroundColor="rgba(141, 136, 136, 0.8)",tn.style.color="#ffff"});
