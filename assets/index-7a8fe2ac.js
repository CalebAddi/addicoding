...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function va(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:os(),fragmentShader:`
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function xa(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:os(),fragmentShader:`
...
`)}function yf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function si(i){return i!==""}function Ra(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ca(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Tf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zr(i){return i.replace(Tf,Af)}const bf=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Af(i,e){let t=we[e];if(t===void 0){const n=bf.get(e);if(n!==void 0)t=we[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Zr(t)}const wf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function La(i){return i.replace(wf,Rf)}function Rf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Pa(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Cf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Wa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===rl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Wt&&(e="SHADOWMAP_TYPE_VSM"),e}function Lf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Yn:case $n:e="ENVMAP_TYPE_CUBE";break;case $i:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Pf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case $n:e="ENVMAP_MODE_REFRACTION";break}return e}function Uf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ya:e="ENVMAP_BLENDING_MULTIPLY";break;case Tl:e="ENVMAP_BLENDING_MIX";break;case bl:e="ENVMAP_BLENDING_ADD";break}return e}function Df(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function If(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Cf(t),c=Lf(t),h=Pf(t),f=Uf(t),d=Df(t),m=t.isWebGL2?"":Sf(t),x=Ef(s),v=r.createProgram();let p,u,y=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(si).join(`
`)),o=Zr(o),o=Ra(o,t),o=Ca(o,t),a=Zr(a),a=Ra(a,t),a=Ca(a,t),o=La(o),a=La(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
                  ...
                  Depending on the weather conditions and time of day your sea traversal may vary. Some places will only be traversable depending on when the tides are lower or higher.</p></div> <img class="water-gif svelte-1bv6dcy" src="/src/assets/gifs/Water_BoatExample.gif" alt="Water Weather Change Example"/> <div class="water-gif02 svelte-1bv6dcy"><img class="water-gif svelte-1bv6dcy" src="/src/assets/gifs/Weather_Change.gif" alt="Weather Change Example"/></div></div></div> <div class="OA_Main svelte-1bv6dcy"><h3 class="svelte-1bv6dcy">Ocean Aero</h3> <div class="oa-txt svelte-1bv6dcy"><p>Worked on the Full Stack Development of the GUI for controlling the Triton.
                I also helped with creating simulations using UE5 to take Semantic Segmentation images for Deep Learning to train the AI to understand different obstacles for Obstacle Avoidance.</p></div> <div class="oa-vid svelte-1bv6dcy"><iframe class="oa-img svelte-1bv6dcy" src="https://www.youtube.com/embed/fybcM4BzEtA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div></div></article> <article id="personal_work" class="svelte-1bv6dcy"><h2 class="svelte-1bv6dcy">Personal Projects</h2> <div class="web_main"><h3 class="svelte-1bv6dcy">Three.js Globe Site</h3></div> <div class="jsGame-main"><h3 class="svelte-1bv6dcy">Survive The Swarm</h3></div></article> <article id="about" class="svelte-1bv6dcy"><h2 class="svelte-1bv6dcy">About</h2> <span class="image main"><img src="./src/images/pic03.JPG" alt=""/></span> <p>My name is Caleb, and I&#39;m a Software Engineer.</p> <p>As a Software Engineer, I&#39;ve worked on websites for various fields and businesses. I&#39;ve
