...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
                  ...
                  Every part of the enemy will have weight to how you kill enemies as well (hitting the AI in the head should do more damage than if it was hit in the shoulder).</p></div> <iframe class="combat-gif" src="https://www.youtube.com/embed/OwQqwBWH-lM?si=r3pJYfkf5jRGl_rV" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div> <div class="water_system"><div class="water-txt"><p>Develop and implement the logic and structure of the Water/Boat System.
                  ...
                  Depending on the weather conditions and time of day your sea traversal may vary. Some places will only be traversable depending on when the tides are lower or higher.</p></div> <iframe class="water-gif" src="https://www.youtube.com/embed/c4UHRE1iIA4?si=rYBoL4jfaZC765f2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe> <div class="water-gif02"></div></div></div> <div class="OA_Main"><h3>Ocean Aero</h3> <div class="oa-txt"><p>Worked on the Full Stack Development of the GUI for controlling the Triton.
