...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
              ...
              I also helped with creating simulations using UE5 to take Semantic Segmentation images for Deep Learning to train the AI to understand different obstacles for Obstacle Avoidance.</p> <div class="oa-container"><div class="oa-txt"><p>Being on a small team of Software Engineers, we had multiple hats we would have to wear in order to get the job done.
                  ...
                  Using UE5, we were able to fast track the machine learning process of the Triton, saving hundreds of man hours and thousands of dollars to get the outcome we needed.</p></div> <div class="oa-vid"><iframe class="oa-img" src="https://www.youtube.com/embed/fybcM4BzEtA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div></div></div></article> <article id="personal_work"><h2>Personal Projects</h2> <div class="web_main"><h3 style="border-bottom: solid 1px rgb(215, 200, 200, 0.7); padding-bottom: 0.5em; text-shadow: 5px 5px black;">Simple Web Projects</h3> <div class="span_div"><span><a href="https://celadon-daifuku-b4fd9b.netlify.app/" target="_blank"><img class="span_img" src="./src/assets/images/shopify.png" alt="Simple-React-Template"/></a> <h3>Admin Dashboard (Using ReactJS)</h3></span></div> <div class="span_div"><span><a href="https://spiffy-liger-2e0760.netlify.app/" target="_blank"><img class="span_img" src="./src/assets/images/planetearth.png" alt="threejs-globe"/></a> <h3>Earth Charity Hub (Using Three.js)</h3></span></div></div> <div class="jsGame-main"><h3 style="border-bottom: solid 1px rgb(215, 200, 200, 0.7); padding-bottom: 0.5em; text-shadow: 5px 5px black;">Simple JS Games</h3> <div class="span_div"><span><a href="./src/assets/projects/FirstJSGame/jsgame01.html" target="_blank"><img class="span_img" src="./src/assets/images/surviveswarm.png" alt=""/></a> <h3 class="h3_lilJS">Survive The Swarm</h3></span></div> <div class="span_div"><span><a href="./src/assets/projects/DiceGame/index.html" target="_blank"><img class="span_img" src="./src/assets/images/diceroll.png" alt=""/></a> <h3 class="h3_lilJS">Dice Roll (Requires 2 Players)</h3></span></div> <div class="span_div"><span><a href="./src/assets/projects/GuessMyNumber/index.html" target="_blank"><img class="span_img" src="./src/assets/images/guessnum.png" alt=""/></a> <h3 class="h3_lilJS">Guess The Number</h3></span></div></div></article> <article id="about"><h2>About</h2> <div class="about-container"><p>My name is Caleb, and I&#39;m a Software Engineer.</p> <p>As a Software Engineer, I&#39;ve worked on websites for various fields and businesses. I&#39;ve
